...
public class FlatKitOutline : ScriptableRendererFeature {
    ...
    private void SetMaterialProperties() {
        ...
        const string colorDepthOutputKeyword = "_COLORDEPTHOUTPUT";
        RendererFeatureUtils.SetKeyword(_effectMaterial, colorDepthOutputKeyword, settings.outputColorDepth);
